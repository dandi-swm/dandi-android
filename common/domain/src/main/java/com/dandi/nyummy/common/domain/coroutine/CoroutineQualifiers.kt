package com.dandi.nyummy.common.domain.coroutine

import javax.inject.Qualifier

/**
 * 앱 전역에서 IO 바운드 작업에 사용하는 디스패처. 내부적으로 [kotlinx.coroutines.Dispatchers.IO] 를
 * `limitedParallelism` 으로 감싸 동시 실행 쓰레드 수를 [com.dandi.nyummy.common.presentation.coroutine.CoroutineModule] 에
 * 정의된 상한 이하로 제한한다.
 */
@Qualifier
