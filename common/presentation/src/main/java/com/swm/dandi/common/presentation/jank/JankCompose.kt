 ...
 *
 * 사용 위치: [com.swm.dandi.main.presentation.navigation.AppNavHost] 의
 * 백스택 최상위가 변경될 때마다 호출.
 */
@Composable
 ...
 *
 * 사용 위치: 검색 [com.swm.dandi.common.presentation.searchList.ContentsList] 와
 * 즐겨찾기 그리드 [com.swm.dandi.common.presentation.searchList.ContentsGrid] 의 스크롤 상태.
 */
@Composable
