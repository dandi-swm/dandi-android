...
| 파일 | 역할 |
|---|---|
| [ui/token/DesignTokens.kt](../../common/presentation/src/main/java/com/swm/dandi/common/presentation/ui/token/DesignTokens.kt) | **토큰 기본값 전부.** `FIGMA-TOKEN-INJECTION-POINT` 마커 3개(palette / semantic-colors / type-scale) — `design-token-sync` 스킬의 유일한 수정 대상 |
| [ui/color/ColorSemantic.kt](../../common/presentation/src/main/java/com/swm/dandi/common/presentation/ui/color/ColorSemantic.kt) | 슬롯 구조 `ArchiSemanticColors` (bg/border/content × level + accent/favorite) |
| [ui/typo/ArchiTypeScale.kt](../../common/presentation/src/main/java/com/swm/dandi/common/presentation/ui/typo/ArchiTypeScale.kt) | 타이포 슬롯 (titleStrongL, textRegularM, ...) |
| [ui/theme/ArchiTheme.kt](../../common/presentation/src/main/java/com/swm/dandi/common/presentation/ui/theme/ArchiTheme.kt) | CompositionLocal 주입 + Material3 colorScheme 폴백 매핑 |
...
- 텍스트는 [ArchiText](../../common/presentation/src/main/java/com/swm/dandi/common/presentation/component/Text.kt) 경유 (Material Text 직접 사용 지양)
- 시맨틱 슬롯은 팔레트만 참조 — `Color(0xFF...)` 리터럴은 DesignTokens.kt 팔레트 정의에만 존재 가능
- 공통 컴포넌트 우선 재사용: ArchiText / BackArrowButton / FavoriteHeartButton / ContentsList / MediaSearchBar ([component/](../../common/presentation/src/main/java/com/swm/dandi/common/presentation/component/), [searchList/](../../common/presentation/src/main/java/com/swm/dandi/common/presentation/searchList/))
